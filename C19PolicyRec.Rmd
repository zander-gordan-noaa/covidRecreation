...
We assemble monthly observations from 2017-2020 for three different modes of fishing: private boats, charter boats, and shore. With `r length(unique(tripsT3$Year))` years, `r length(unique(tripsT3$Month))` months in each year and `r length(unique(tripsT3$State))` states, the data set for each mode has `r length(tripsT3$Trips[tripsT3$Mode==7])` observations. 
