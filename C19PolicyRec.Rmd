...
```{r noDataSms, echo=FALSE,warning=FALSE}
...
pm=glm(mf,data=data_for_new_model,family = quasipoisson,subset=Mode==7 )
cm=glm(mf,data=data_for_new_model,family = quasipoisson,subset=Mode==5 )
sm=glm(mf,data=data_for_new_model,family = quasipoisson,subset=Mode==3 )
...
#Using June 2020 in Florida: zero stringency should correspond with
...
plot(y=cd$pred/1000000,x=cd$Stringency,type="l",ylim=c(.04,.09),xlim=c(3000,0),
     main="Charter Boats",
     xlab="Stringency Index (Monthly sum of daily records: higher is more stringent)",
     ylab="Millions of Fishing Trips (Scaled to June 2020 in FL)")
lines(y=cd$LCB0.025/1000000,x=cd$Stringency,lty=2)
lines(y=cd$UCB0.975/1000000,x=cd$Stringency,lty=2)
abline(h=cd$pred[cd$Stringency==0]/1000000)

plot(y=sd$pred/1000000,x=sd$Stringency,type="l",ylim=c(3,7),xlim=c(3000,0),
     main="Shore",
     xlab="Stringency Index (Monthly sum of daily records: higher is more stringent)",
     ylab="Millions of Fishing Trips (Scaled to June 2020 in FL)")
lines(y=sd$LCB0.025/1000000,x=sd$Stringency,lty=2)
lines(y=sd$UCB0.975/1000000,x=sd$Stringency,lty=2)
abline(h=sd$pred[sd$Stringency==0]/1000000)

par(mfrow=c(1,1))

#Use this to reverse the x-axis: xlim=c(0,3000)
